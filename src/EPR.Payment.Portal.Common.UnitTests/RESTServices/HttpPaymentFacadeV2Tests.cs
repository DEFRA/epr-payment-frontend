...
{
    [TestClass]
    public class HttpPaymentFacadeV2Tests
    {
        private Mock<IHttpContextAccessor> _httpContextAccessorMock = null!;
        private Mock<IOptions<FacadeServiceV2>> _configMock = null!;
        ...
        public void Initialize()
        {
            ...
            _configMock = new Mock<IOptions<FacadeServiceV2>>();
        ...
        private HttpPaymentFacadeV2 CreateHttpPaymentsService(HttpClient httpClient)
        {
            return new HttpPaymentFacadeV2(
        ...
        public async Task CompletePaymentAsync_Success_ReturnsPaymentDetailsDto(
            ...
            HttpPaymentFacadeV2 httpPaymentsFacade,
        ...
        {
            // Act
            Action act = () => _ = new HttpPaymentFacadeV2(
                null!,
        ...
        {
            // Arrange
            _configMock.Setup(x => x.Value).Returns(new FacadeServiceV2
            {
                Url = null, // Null URL
                EndPointName = "payments",
                DownstreamScope = "scope_value"
